...
# discovery the 1st address on the default route subnet
...
resource "ibm_is_instance" "f5_ve_instance" {
  ...
  placement_group = var.placement_group_id != "" && var.placement_group_id != null ? var.placement_group_id : null
  ...
  primary_network_interface {
    ...
    primary_ipv4_address = var.mgmt_primary_ip != "" && var.mgmt_primary_ip != null ? var.mgmt_primary_ip : null
  }
  ...
  dynamic "network_interfaces" {
    ...
    content {
      ...
      primary_ipv4_address = length(var.data_interface_ips) > 0 && var.data_interface_ips[0] != "" ? var.data_interface_ips[0] : null
    }
  }
  ...
  dynamic "network_interfaces" {
    ...
    content {
      ...
      security_groups      = [ibm_is_security_group.f5_open_sg.id]
      allow_ip_spoofing    = true
      primary_ipv4_address = length(var.data_interface_ips) > 1 && var.data_interface_ips[1] != "" ? var.data_interface_ips[1] : null
    }
  }
  ...
  dynamic "network_interfaces" {
    ...
    content {
      ...
      security_groups      = [ibm_is_security_group.f5_open_sg.id]
      allow_ip_spoofing    = true
      primary_ipv4_address = length(var.data_interface_ips) > 2 && var.data_interface_ips[2] != "" ? var.data_interface_ips[2] : null
    }
  }
